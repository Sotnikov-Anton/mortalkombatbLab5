...
public class CharacterAction {
    ...
    public Player chooseEnemy(JLabel label, JLabel label2, JLabel text, JLabel label3){// throws IOException {
        ...
        switch (i) {
            case 0:
                enemyy = enemies[0];
                //icon1 = new ImageIcon(".\\src\\main\\resources\\Baraka.png");
                //icon1 = ImageIO.read(getClass().getResource("/resources/Baraka.png"));
                //icon1 = new ImageIcon(JFrames.class.getResource("Baraka.png"));
                icon1 = new ImageIcon(System.getProperty("user.dir") + "/Baraka.png");
                label2.setText("Baraka (танк)");
                break;
            case 1:
                enemyy = enemies[1];
                //icon1 = new ImageIcon(".\\src\\main\\resources\\Sub_zero.png");
                //icon1 = ImageIO.read(getClass().getResource("/resources/Sub_zero.png"));
                //icon1 = new ImageIcon(JFrames.class.getResource("Sub_zero.png"));
                icon1 = new ImageIcon(System.getProperty("user.dir") + "/Sub_zero.png");
                label2.setText("Sub-Zero (маг)");
                break;
            case 2:
                enemyy = enemies[2];
                //icon1 = new ImageIcon(".\\src\\main\\resources\\LiuKang.png");
                //icon1 = ImageIO.read(getClass().getResource("/resources/LiuKang.png"));
                //icon1 = new ImageIcon(JFrames.class.getResource("LiuKang.png"));
                icon1 = new ImageIcon(System.getProperty("user.dir") + "/LiuKang.png");
                label2.setText("Liu Kang (боец)");
                break;
            case 3:
                enemyy = enemies[3];
                //icon1 = new ImageIcon(".\\src\\main\\resources\\Sonya_blade.jpg");
                //icon1 = ImageIO.read(getClass().getResource("/resources/Sonya_blade.jpg"));
                //icon1 = new ImageIcon(JFrames.class.getResource("Sonya_blade.jpg"));
                icon1 = new ImageIcon(System.getProperty("user.dir") + "/Sonya_blade.jpg");
    ...
    public Player chooseBoss(JLabel label, JLabel label2, JLabel text, JLabel label3, int i) {
        ImageIcon icon1 = null;
        //icon1 = new ImageIcon(".\\src\\main\\resources\\Shaokhan.jpg");
        icon1 = new ImageIcon(System.getProperty("user.dir") + "/Shaokhan.jpg");
...
//        }
    ...
    {
        String[] options = {"Defence", "Offence"};
        int answer = JOptionPane.showOptionDialog(null, "Choose your upgrade", "selection", 0,1,null, options, options[0]);
        return answer;
    }
    /**
