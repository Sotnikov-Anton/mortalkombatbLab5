...
public class Fight {
    ...
    public void hit(Player human, Player enemy, int a, JLabel label, JLabel label2, JDialog dialog, JLabel label3, CharacterAction action,
            ...
            JLabel label6, JLabel label7, JLabel label8, Item[] items, JRadioButton rb, JLabel changeLocationLabel, JPanel backgroundPanel) {
        label7.setText("");
        human.setAttack(a);
     ...
     * @param BackgroundPanel Главное окно игры с боем
     */
    public void endRound(Player human, Player enemy, JDialog dialog, JLabel label, CharacterAction action, Item[] items, JLabel changeLocationLabel,
